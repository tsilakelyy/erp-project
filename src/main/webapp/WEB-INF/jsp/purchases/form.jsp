...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                ...
                <button class="btn btn-primary" onclick="navigateTo('/erp-system/purchases/orders/new')">Nouvelle commande</button>
            </div>
    ...
    <script>
        ...
        function loadPurchaseOrders() {
            ajaxCall('/erp-system/api/purchase-orders', 'GET', null,
                function(response) {
        ...
        function renderOrdersTable(orders) {
            ...
            orders.forEach(order => {
                ...
                const expectedDate = order.dateExpectedDelivery ? new Date(order.dateExpectedDelivery).toLocaleDateString() : '-';
                row.innerHTML = `
        ...
        function viewOrder(id) {
            navigateTo('/erp-system/purchases/orders/' + id);
        }

        function editOrder(id) {
            navigateTo('/erp-system/purchases/orders/new?id=' + id);
        }
    </script>
