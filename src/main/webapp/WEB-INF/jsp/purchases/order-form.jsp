...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                <h1 id="orderNumber">Purchase Order Details</h1>
                <a href="/erp/purchases/orders-list" class="btn btn-secondary">Back</a>
            </div>
    ...
    <script>
        ...
        function loadOrderDetail(id) {
            ajaxCall('/erp/api/purchase-orders/' + id, 'GET', null,
                function(order) {
                    document.getElementById('orderNumber').textContent = 'Purchase Order: ' + order.numero;
                    const html = `
                        ...
                        <div class="detail-row">
                            <div class="detail-item"><strong>Supplier:</strong> ${order.fournisseur}</div>
