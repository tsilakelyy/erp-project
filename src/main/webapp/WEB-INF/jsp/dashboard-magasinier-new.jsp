...
<head>
    ...
    <title>Dashboard Stock - ERP</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <jsp:include page="/WEB-INF/jsp/layout/styles.jsp"/>
    <style>
        .kpi-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin: 20px 0; }
        .kpi-card { background: white; border-radius: 8px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-left: 4px solid #ffc107; }
        ...
        .section-header { font-size: 18px; font-weight: bold; margin-top: 35px; margin-bottom: 15px; color: #333; border-bottom: 2px solid #ffc107; padding-bottom: 10px; display: flex; align-items: center; }
        .section-header::before { content: ''; display: inline-block; width: 4px; height: 24px; background: #ffc107; margin-right: 12px; }
    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                <h1>Magasin / Responsable Stock</h1>
                <p style="color: #666; margin-top: 8px; font-size: 14px;">KPIs d'entrepôt et gestion des stocks</p>
            </div>
            ...
            <c:if test="${not empty kpis}">
                <div class="section-header">Précision & Qualité Inventory</div>
                <div class="kpi-grid">
                ...
                <div class="section-header">Productivité Opérationnelle</div>
                <div class="kpi-grid">
                    <c:forEach items="${kpis}" var="entry" varStatus="loop">
                        <c:if test="${loop.index > 3}">
                            <div class="kpi-card">
