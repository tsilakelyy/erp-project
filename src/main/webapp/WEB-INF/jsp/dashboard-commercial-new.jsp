...
<head>
    ...
    <title>Dashboard Ventes - ERP</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <jsp:include page="/WEB-INF/jsp/layout/styles.jsp"/>
    <style>
        .kpi-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin: 20px 0; }
        .kpi-card { background: white; border-radius: 8px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-left: 4px solid #17a2b8; }
        ...
        .section-header { font-size: 18px; font-weight: bold; margin-top: 35px; margin-bottom: 15px; color: #333; border-bottom: 2px solid #17a2b8; padding-bottom: 10px; display: flex; align-items: center; }
        .section-header::before { content: ''; display: inline-block; width: 4px; height: 24px; background: #17a2b8; margin-right: 12px; }
    ...
    <div class="main-content">
        <div class="container">
            <div class="page-header">
                <h1>Ventes / Responsable Commercial</h1>
                <p style="color: #666; margin-top: 8px; font-size: 14px;">KPIs commerciaux et de satisfaction client</p>
            </div>
            ...
            <c:if test="${not empty kpis}">
                <div class="section-header">Performance Commandes</div>
                <div class="kpi-grid">
                ...
                <div class="section-header">Remises & Avoirs</div>
                <div class="kpi-grid">
                    <c:forEach items="${kpis}" var="entry" varStatus="loop">
                ...
                <div class="section-header">Backlog & Disponibilité</div>
                <div class="kpi-grid">
                    <c:forEach items="${kpis}" var="entry" varStatus="loop">
